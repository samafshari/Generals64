...
// Use RWStructuredBuffer at u0 (→ binding 30 with -fvk-u-shift 30) to avoid
// conflict with the main descriptor set layout's SAMPLED_IMAGE at binding 10.
// Only read access is used despite the RW type.
