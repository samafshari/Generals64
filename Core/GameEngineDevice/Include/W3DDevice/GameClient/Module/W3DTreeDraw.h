...
private:
	...
	// Guard so we only register this tree with the terrain prop buffer once.
	// Mirrors the original ZH W3DTreeDraw::m_treeAdded flag — see .cpp for the
	// regression that motivated restoring this.
	Bool m_treeAdded;
