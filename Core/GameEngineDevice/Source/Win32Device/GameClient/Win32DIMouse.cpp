...
void DirectInputMouse::setMouseLimits()
{
	...
	// In windowed mode, don't clip the cursor — let the user access
	// title bar, window buttons, and other applications.
	// In fullscreen, clip to the window to prevent escaping.
...
{
	// In windowed mode, don't capture — let clicks on the title bar
	// and window controls be handled by Windows, not the game.
