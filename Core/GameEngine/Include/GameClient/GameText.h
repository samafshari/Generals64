...
class GameTextInterface : public SubsystemInterface
{
	...
	public:
		...
		virtual UnicodeString fetch( AsciiString label, Bool *exists = nullptr ) = 0;		///< Returns the associated labeled unicode text ; a contributor @todo Remove
...
#if __cplusplus < 201103L // a contributor @todo Remove function when abandoning VC6
...
#if __cplusplus >= 201103L // a contributor @todo Remove condition when abandoning VC6
