...
protected:
	static constexpr int CONTROLBARARROWTRANSITION_START = 0;
	static constexpr int CONTROLBARARROWTRANSITION_BEGIN_FADE = 16;
	static constexpr int CONTROLBARARROWTRANSITION_END = 22;		// Max text type we'll allow.
	ICoord2D m_pos;
