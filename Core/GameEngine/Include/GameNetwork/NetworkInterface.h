...
public:
	...
	virtual void setFrameRate(Int fps) = 0;												///< Set the lockstep network frame rate (host-chosen via GameInfo::getGameFps).
	...
	virtual void setTransportRelayMode(Bool relay) = 0;
