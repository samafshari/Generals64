 ...
 * uniquely identified by their session IDs.
 */
class LANPlayer
{
public:
	LANPlayer() { m_name = m_login = m_host = L""; m_lastHeard = 0; m_next = nullptr; m_IP = 0; m_sessionID = 0; }
	...
	UnsignedInt getSessionID() { return m_sessionID; }
...
protected:
	...
	UnsignedInt m_IP;					///< Player's IP (used for transport addressing)
	UnsignedInt m_sessionID;	///< Player's unique session ID (used for identification)
};
