...
// ----------------------------------------------------------------------------------------------
static constexpr int BaseFps = 30; // The historic base frame rate for this game. This value must never change.
static constexpr int LOGICFRAMES_PER_SECOND = WWSyncPerSecond;
static constexpr int MSEC_PER_SECOND = 1000;
