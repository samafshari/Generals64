...
//
// Bumped from the original 128 to 512 to give the minimap a sharp, modern look
// on high-DPI displays. The D3D11 sampler filters this bilinearly when drawn,
// so 512 + bilinear gives a noticeably crisper terrain image.
static constexpr int RADAR_CELL_WIDTH  = 512;	// radar created at this horz resolution
static constexpr int RADAR_CELL_HEIGHT = 512;	// radar created at this vert resolution
...
protected:
	...
	static constexpr int MAX_RADAR_EVENTS = 64;
	struct RadarEvent
	{
