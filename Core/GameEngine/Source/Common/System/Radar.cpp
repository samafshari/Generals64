...
// PRIVATE ////////////////////////////////////////////////////////////////////////////////////////
#define RADAR_QUEUE_TERRAIN_REFRESH_DELAY (static_cast<int>(LOGICFRAMES_PER_SECOND) * 3.0f)
																 ...
																 const RGBAColorInt *color1, const RGBAColorInt *color2 )
{
	...
	m_event[ m_nextFreeRadarEvent ].dieFrame = TheGameLogic->getFrame() + static_cast<int>(LOGICFRAMES_PER_SECOND) * secondsToLive;
	m_event[ m_nextFreeRadarEvent ].fadeFrame = m_event[ m_nextFreeRadarEvent ].dieFrame - static_cast<int>(LOGICFRAMES_PER_SECOND) * secondsBeforeDieToFade;
...
Bool Radar::tryEvent( RadarEventType event, const Coord3D *pos )
{
	...
	const UnsignedInt framesBetweenEvents = static_cast<int>(LOGICFRAMES_PER_SECOND) * 10;
	//
...
/** Xfer Method
	* Version Info:
	* 1: Initial version
	* 2: Serialize m_radarHidden, m_radarForceOn for each player
	*/
// ------------------------------------------------------------------------------------------------
