...
// Local big-endian conversion used by the CRC code (was Utility/endian_compat.h).
static inline UnsignedInt htobe(UnsignedInt v)
{
    return static_cast<UnsignedInt>(_byteswap_ulong(static_cast<unsigned long>(v)));
}
