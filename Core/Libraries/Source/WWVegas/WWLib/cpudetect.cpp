...
// MSVC intrinsic wrapper matching the two-argument form used by cpudetect.cpp.
#define cpuid(regs, cpuid_type) __cpuid(reinterpret_cast<int*>(regs), static_cast<int>(cpuid_type))
