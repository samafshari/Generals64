...
SoundStreamHandleClass::SoundStreamHandleClass ()	:
	SampleHandle (reinterpret_cast<HSAMPLE>(INVALID_MILES_HANDLE)),
	StreamHandle (reinterpret_cast<HSTREAM>(INVALID_MILES_HANDLE))
{
	return ;
}
...
{
	if (StreamHandle != reinterpret_cast<HSTREAM>(INVALID_MILES_HANDLE)) {
...
{
	if (SampleHandle != reinterpret_cast<HSAMPLE>(INVALID_MILES_HANDLE)) {
...
{
	SampleHandle = reinterpret_cast<HSAMPLE>(handle);
	return ;
}
