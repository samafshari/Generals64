...
// D3D11: This Render() is intentionally empty. The D3D11 implementation
// is in D3D11Shims.cpp Line3DClass::Render() which builds camera-facing
// quads and renders via the D3D11 Renderer with additive blending.
// The linker resolves to the D3D11Shims version because it's in the
// GameEngineDevice library which is linked after the WW3D2 library.
//
// If this version gets called instead (linker order issue), it's a safe
// no-op — the line simply won't render rather than corrupting state.
