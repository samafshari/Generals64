...
public:
	...
	DazzleRenderObjClass();  // Default constructor for persist factory
   ...
   virtual void					Get_Obj_Space_Bounding_Box(AABoxClass & box) const;
	...
	// D3D11 rendering accessors
	float Get_Dazzle_Intensity() const { return current_dazzle_intensity; }
	float Get_Dazzle_Size() const { return current_dazzle_size; }
	float Get_Halo_Intensity() const { return current_halo_intensity; }
	float Get_Scale() const { return current_scale; }
	const Vector3& Get_Dazzle_Color() const { return dazzle_color; }
	const Vector3& Get_Halo_Color() const { return halo_color; }
