...
void CameraClass::Apply()
{
	...
	// D3D11: viewport and transforms are set through the Renderer
	// The camera math (projection matrix, view matrix) is still valid
	// and will be passed to the Renderer when drawing.
}
