...
void AI::parseSideInfo(INI *ini, void *instance, void* /*store*/, const void* /*userData*/)
{
	...
	static const FieldParse myFieldParse[] = 
      ...
      { "ResourceGatherersBrutal",			INI::parseInt,						NULL, offsetof( AISideInfo, m_brutal ) },
      { "ResourceGatherersInsane",			INI::parseInt,						NULL, offsetof( AISideInfo, m_insane ) },
      { "ResourceGatherersNightmare",		INI::parseInt,						NULL, offsetof( AISideInfo, m_nightmare ) },
...
{
	LIVE_PERF_SCOPE("AI::findClosestEnemy");
