...
private:
	...
	*/
	...
	ObjectID			m_cachedMoodTargetID;		///< Last victim from findClosestEnemy; reused if still valid to skip a grid scan
	...
	// Locomotor choice cache - avoid redundant pathfinder lookups
	Int					m_lastLocoCellX;
	Int					m_lastLocoCellY;
	PathfindLayerEnum m_lastLocoLayer;
};
