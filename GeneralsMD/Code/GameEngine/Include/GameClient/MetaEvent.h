...
enum MappableKeyCategories : Int
{
	CATEGORY_CONTROL = 0,
...
// -------------------------------------------------------------------------------
enum MappableKeyTransition : Int
{
	DOWN,
	UP,
