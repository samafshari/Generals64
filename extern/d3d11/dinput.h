#pragma once
// DirectInput replacement - keyboard scancodes and minimal type definitions.
// The actual input is handled by Win32 messages, not DirectInput.
...
// DirectInput keyboard scancodes (same as PS/2 scancodes)
...
// Stub COM types - never instantiated
struct IDirectInput8A { void* _unused; };
struct IDirectInputDevice8A { void* _unused; };
